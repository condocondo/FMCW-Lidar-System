...
for i in range(1):
    ...
    AF = get_AF_discretized_phase_error(N_antennas_per_block=N_antennas_per_block, N_block=N_block, array_pitch=array_pitch, delay_length=delay_length, n_eff=neff, wavelength=wavelength_min, angles=angles, phase_error_order = i*2)
    ...
    plt.plot(angles, AF_normalized_dB, label="um, "+ "Array pitch = "+ str(array_pitch)+"um, "+ "N = "+ str(N)+"phase error = pi / "+str(10*i))
