...
tree_waveguides = [Wg(length=DELAY) for _ in range(2 * N)]
...
for i in range(1, N):
    ...
    if i % 2 == 1:
        ...
        if dummy2 < N / 2:
            ...
            current_tree = [tree_splitters[0](1)]
            current_tree.append(tree_waveguides[wg_counter]())
...
'''        
        ...
        for k in range(1, int(np.log2(i))):
            current_tree.append(tree_splitters[k]())
        
        current_tree.append(tree_splitters )
